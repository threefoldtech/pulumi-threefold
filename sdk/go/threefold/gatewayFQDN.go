...
func NewGatewayFQDN(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("threefold:index:GatewayFQDN", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayFQDN(ctx *pulumi.Context,
	...
	var resource GatewayFQDN
	err := ctx.ReadResource("threefold:index:GatewayFQDN", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
