...
namespace Pulumi.Threefold
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Threefold.version.txt");
    ...
    internal sealed class ThreefoldResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ThreefoldResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
