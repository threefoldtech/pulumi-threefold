...
namespace Pulumi.Grid
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Grid.version.txt");
    ...
    internal sealed class GridResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GridResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
