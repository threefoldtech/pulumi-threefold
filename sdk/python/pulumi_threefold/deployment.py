...
class DeploymentArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def solution_provider(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def solution_provider(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("threefold:index:Deployment")
class Deployment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def solution_provider(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        ID for the deployed solution which allows the creator of the solution to gain a percentage of the rewards
        """
        return pulumi.get(self, "solution_provider")
