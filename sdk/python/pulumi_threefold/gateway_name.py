...
class GatewayNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] tls_passthrough: TLS passthrough controls the TLS termination, if false, the gateway will terminate the TLS, if True, it will only be terminated by the backend service
        """
...
@pulumi.type_token("threefold:index:GatewayName")
class GatewayName(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def name_contract_id(self) -> pulumi.Output[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tls_passthrough(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        TLS passthrough controls the TLS termination, if false, the gateway will terminate the TLS, if True, it will only be terminated by the backend service
        """
        return pulumi.get(self, "tls_passthrough")
