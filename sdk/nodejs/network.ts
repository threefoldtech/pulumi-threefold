...
export class Network extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly access_wg_config: pulumi.Output<string>;
    /**
     * A flag to support wireguard in the network
     */
    declare public readonly add_wg_access: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly external_ip: pulumi.Output<string>;
    /**
     * External user private key used in encryption while communicating through Wireguard network
     */
    declare public /*out*/ readonly external_sk: pulumi.Output<string>;
    /**
     * The IP range for the network, subnet should be 16
     */
    declare public readonly ip_range: pulumi.Output<string>;
    /**
     * A flag to generate a random mycelium key to support mycelium in the network
     */
    declare public readonly mycelium: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly mycelium_keys: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     ...
     */
    declare public readonly nodes: pulumi.Output<any[]>;
    /**
     ...
     */
    declare public /*out*/ readonly public_node_id: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, args: NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.ip_range === undefined && !opts.urn) {
            ...
            resourceInputs["add_wg_access"] = args?.add_wg_access;
            resourceInputs["description"] = args?.description;
            resourceInputs["ip_range"] = args?.ip_range;
            resourceInputs["mycelium"] = args?.mycelium;
            resourceInputs["mycelium_keys"] = args?.mycelium_keys;
            resourceInputs["name"] = args?.name;
            resourceInputs["nodes"] = args?.nodes;
            resourceInputs["solution_type"] = (args?.solution_type) ?? "Network";
